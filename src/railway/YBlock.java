...
public class YBlock extends Block {
     ...
     */
    private List<SwitchPosition> nextSwitches = new LinkedList<SwitchPosition>();

    /**
     * List of the sectors after the stop
     */
    private List<Sector> endSectors = new LinkedList<Sector>();

    /**
     * List of the sectors which are after the stop and not in the incoming
     * block.
     */
    private List<Sector> tailSectors = new LinkedList<Sector>();
    ...
    static public boolean isYBlockPossible(Block from, Block to) {
        ...
        /*
         * It seems a YBlock may be made from these two blocks
         */
        return true;
    }
    ...
    public void setNextSwitches() {
        if (!isStopSectorOccupied()) {
            Logger.log("Warning, setting next switches of "+id+" but no train"
    ...
    public String toString() {
        String res = "YBlock["+getId()+"]<"+(int)switchlessLength+">";
        return res;
    }
